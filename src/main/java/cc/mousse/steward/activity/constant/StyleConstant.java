...
public class StyleConstant {
  ...
  public static final String GRAY = SECTION.concat("7");
  public static final String DARK_GRAY = SECTION.concat("8");
  public static final String BLUE = SECTION.concat("9");
  public static final String GREEN = SECTION.concat("a");
  public static final String AQUA = SECTION.concat("b");
  public static final String RED = SECTION.concat("c");
  public static final String YELLOW = SECTION.concat("e");
